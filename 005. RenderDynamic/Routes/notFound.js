...
route.get("/*", (req, res) => {
  ...
  */
  ...
  // {Render Dynamic: EJS} //
  res.status(404).render("404", { title: "Page Not Found", path: "" }); // render file 404.ejs trong thư mục views/pug đã được set ở server.js, truyền vào đối số là một object chứa các thuộc tính cần thiết, được sử dụng trong file 404.ejs
});
