...
route.get("/products", CreateCSRFTOKEN, userController.getAllProduct);

// {ADD PRODUCT ID} //
route.get("/products/:productID", CreateCSRFTOKEN, userController.getDetail); // :productID là dynamic route, nó sẽ được thay thế bằng id của sản phẩm,
...
route.get("/orders", CreateCSRFTOKEN, ProtectRoute, userController.getOrder);
